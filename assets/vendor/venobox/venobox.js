    ...
    $.fn.extend({
        ...
        venobox: function(options) {
            ...
            return this.each(function() {
                ...
                obj.on('click', function(e){
                    ...
                    overlay.animate({opacity:1}, 250, function(){
                        ...
                        if (obj.data('vbtype') == 'iframe') {
                          ...
                          content.html('<img src="https://www.costadulce.com.py/'+dest+'">');
                          preloadFirst();
                        }
                ...
                /* -------- LOAD IFRAME -------- */
                function loadIframe(){
                    content.html('<iframe class="venoframe" src="https://www.costadulce.com.py/'+dest+'"></iframe>');
                ...
                function loadVid(autoplay){
                    ...
                    content.html('<iframe class="venoframe vbvid" webkitallowfullscreen mozallowfullscreen allowfullscreen allow="autoplay" frameborder="0" src="https://www.costadulce.com.py/'+player+videoObj.id+queryvars+'"></iframe>');
                    updateoverlay();
                }
